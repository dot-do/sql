 ...
 *
 * Turso adapter for edge SQLite benchmarks over HTTP.
 * Tests network latency for remote SQLite access.
 */
...
/**
 * Turso benchmark adapter (remote HTTP mode)
 *
 * Uses @libsql/client with Turso URL for remote SQLite benchmarks.
 * This measures network latency for edge SQLite access.
 */
export class TursoAdapter implements BenchmarkAdapter {
  ...
  async initialize(): Promise<void> {
    ...
    this.connectionTime = performance.now() - connStart;
  ...
  // ===========================================================================
  // CRUD Operations (same as LibSQL but with network latency)
  // ===========================================================================
...
/**
 * Create a Turso benchmark adapter
 */
 ...
 */
export function createTursoAdapterFromEnv(): TursoAdapter | null {
  ...
  return new TursoAdapter({ url, authToken });
}
