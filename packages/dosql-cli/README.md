...
```typescript
import { createCLI } from '@dotdo/dosql-cli';
...
```typescript
import { initProject, generateTypes, findMigrations, runMigrations } from '@dotdo/dosql-cli';
...
```typescript
import { createMigrationConnection, runMigrationsWithConnection } from '@dotdo/dosql-cli';
...
```typescript
// Path validation
import { validatePath, validateCliPath, PathValidationError } from '@dotdo/dosql-cli';

// Error handling
import { toError, getErrorMessage } from '@dotdo/dosql-cli';

// File utilities
import { fileExists, fileExistsSync } from '@dotdo/dosql-cli';

// Logging
import { Logger, createLogger, logInfo, logError } from '@dotdo/dosql-cli';
```
...
**Note:** The `defineConfig` function is provided by the `@dotdo/dosql` package, which is the runtime library for DoSQL applications.
